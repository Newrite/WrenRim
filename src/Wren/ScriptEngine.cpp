...
namespace wren::script_engine
{
  ...
  public:
    ...
    void initialize()
    {
      ...
      vm_->setPathResolveFunc(
        [](const std::vector<std::string>&, const std::string&, const std::string& name) -> std::string {
          return name;
        });
      ...
      binding_manager::bind_wrappers(*vm_);
      ...
      try {
        ...
        binding_manager::load_core_modules(*vm_);
      }
